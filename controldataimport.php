  ...
  <body>
    <div id="wrap">
      ...
      <div class="col-md-2 col-sm-3 col-xs-4" id="menu">
        ...
        <div class="col-md-12"><span class="return-text">Datenimport</div>
        <ul class="btn-group btn-group-lg btn-group-vertical">
          <li class="dropdown navbar-form">
            <a class="dropdown-toggle btn-lg btn-block" href="cdi_forecast.php">
              Forecast
            </a>
          </li>
          <li class="dropdown navbar-form">
            <a class="dropdown-toggle btn-lg btn-block" href="cdi_actuals.php">
              Actuals
            </a>
          </li>
		  <li class="dropdown navbar-form">
            <a class="dropdown-toggle btn-lg btn-block" href="cdi_budget.php">
              Budget
            </a>
          </li>
          <?php if(isset($menus[$_SESSION["roleId"]]) && $menus[$_SESSION["roleId"]] == (2 || 3)) : ?>
            <li class="dropdown navbar-form">
              <a class="dropdown-toggle btn-lg btn-block" href="cdi_stammdaten.php">
                Stammdaten
              </a>
            </li>
          <?php endif; ?>
