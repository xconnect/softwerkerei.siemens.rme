...
<html>
    ...
    <div id="wrap">
        ...
        <ul class="btn-group btn-group-lg btn-group-vertical">
          <li class="dropdown navbar-form">
            <a class="dropdown-toggle btn-lg btn-block" href="admin_users.php">
              Benutzerverwaltung
            </a>
          </li>
          <li class="dropdown navbar-form">
            <a class="dropdown-toggle btn-lg btn-block" href="admin_projects.php">
              Projektverwaltung
            </a>
          </li>
        </ul>
