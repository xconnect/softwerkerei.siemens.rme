  ...
  <body>
    <div id="wrap">
      ...
      <div class="col-md-2 col-sm-3 col-xs-4" id="menu">
        ...
        <div class="col-md-12"><span class="return-text">Datenimport<br /><span style="color:#FFFFFF"><i>Forecast</i></span></span></div>
      </div>
					...
					<div class="col-md-6">
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3 class="panel-title">Import: <b>Forecast</b></h3>
							</div>
							<div class="panel-body">
								...
								<div class="dropdown">
									...
									<ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">
										<li role="presentation"><a role="menuitem" tabindex="-1" href="#">LTP</a></li>
										<li role="presentation"><a role="menuitem" tabindex="-1" href="#">O&amp;M</a></li>
									</ul>
								</div>
								<div class="offset-top-15">Schritt 2: Template herunterladen</div>
								<div class="offset-top-15"><button class="btn btn-warning">Download Template</button></div>
								<div class="offset-top-15">Schritt 3: Template ausfüllen</div>
								<div class="offset-top-15">Schritt 4: Bearbeitetes Template auswählen</div>
								<input type="file" class="btn-primary offset-top-15 btn" id="cdi_sonstiges"/>
								<div class="offset-top-15">Schritt 5: Upload</div>
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3 class="panel-title">Import: <b>Fakturadaten</b></h3>
							</div>
							<div class="panel-body">
								<div>Schritt 1: Auswählen</div>
								<div class="offset-top-15"></div>
								<div class="dropdown">
									...
									<ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">
										<li role="presentation"><a role="menuitem" tabindex="-1" href="#">Fakturapläne</a></li>
										<li role="presentation"><a role="menuitem" tabindex="-1" href="#">Gebuchte Werte</a></li>
									</ul>
								</div>
								<div class="offset-top-15">Schritt 2: Datei auswählen</div>
								<input type="file" class="btn-primary offset-top-15 btn" id="cdi_sonstiges"/>
								<div class="offset-top-15">Schritt 3: Upload</div>
								<div class="offset-top-15"><button class="btn btn-success">Upload</button></div>
							</div>
						</div>
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3 class="panel-title">Import: <b>Landesgesellschaften</b></h3>
							</div>
							<div class="panel-body">
								<div>Schritt 1: Auswählen</div>
								<div class="offset-top-15"></div>
								<div class="dropdown">
									...
									<ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">
										<li role="presentation"><a role="menuitem" tabindex="-1" href="#">Landesgesellschaft 1</a></li>
										<li role="presentation"><a role="menuitem" tabindex="-1" href="#">Landesgesellschaft 2</a></li>
									</ul>
								</div>
								<div class="offset-top-15">Schritt 2: Template herunterladen</div>
								<div class="offset-top-15"><button class="btn btn-warning">Download Template</button></div>
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3 class="panel-title">Import: <b>Controlling sonstige</b></h3>
							</div>
							<div class="panel-body">
								<div>Schritt 1: Auswählen</div>
								<div class="offset-top-15"></div>
								<div class="dropdown">
									...
									<ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">
										<li role="presentation"><a role="menuitem" tabindex="-1" href="#">P&amp;L</a></li>
										<li role="presentation"><a role="menuitem" tabindex="-1" href="#">NetCash</a></li>
									</ul>
								</div>
								<div class="offset-top-15">Schritt 2: Datei auswählen</div>
								<input type="file" class="btn-primary offset-top-15 btn" id="cdi_sonstiges"/>
