...
<html>
  <head>
 		<title>CTS Datenexport - Deviation Analysis</title>
  ...
  <body>
    <div id="wrap">
      ...
      <div class="col-md-2 col-sm-3 col-xs-4" id="menu">
        ...
        <div class="col-md-12"><span class="return-text">Datenexport<br /><span style="color:#FFFFFF"><i>Deviation Analysis</i></span></span></div>
      </div>
					...
					<div class="col-md-6">
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3 class="panel-title">Datenexport - Anleitung: <i>Deviation Analysis</i></h3>
							</div>
							<div class="panel-body">
								...
								<div><b><u>3. Schritt</u></b>: <i>Erstellen der "Deviation Analysis"</i></div>
								<div class="offset-top-15">
