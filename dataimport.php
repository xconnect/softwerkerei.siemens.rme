  ...
  <body>
    <div id="wrap">
      ...
      <div class="col-md-2 col-sm-3 col-xs-4" id="menu">
        ...
        <div class="col-md-12"><span class="return-text">Datenimport</span></div>
      </div>
      <div class="col-md-10 col-sm-9 col-xs-8" id="content">
        <div class="offset-top-15">
          <ul class="nav nav-tabs" role="tablist">
            <li class="active">
              <a role="tab" tabindex="-1" href="#subsegmente" data-toggle="tab">
                Subsegmente
              </a>
            </li>
            <li class="">
              <a role="tab" tabindex="-1" href="#landesgesellschaften" data-toggle="tab">
            ...
            <div class="tab-pane fade in active offset-top-10" id="subsegmente">
              ...
              <div class="container-fluid offset-top-15">
                <div class="col-md-6">
                  ...
                  <div class="offset-top-15"><u>2. Schritt</u></div>
                  <div class="offset-top-15">Daten eingeben und Datei speichern</div>
                  <div class="offset-top-15"><u>3. Schritt</u></div>
                  <input type="file" class="btn-primary offset-top-15 btn" id="dataimport"/>
                  <div class="offset-top-15"><u>4. Schritt</u></div>
                  <div class="offset-top-15">Upload bestätigen oder verwerfen</div>
                  </div>
                </div>
              </div>
            </div>
            <div class="tab-pane fade in offset-top-10" id="landesgesellschaften">
              <div class="text-danger inline-block">
                Dateneingabe für Stichtag <span class="date">11.12.2014</span>
              </div>
              <div class="container-fluid offset-top-15">
