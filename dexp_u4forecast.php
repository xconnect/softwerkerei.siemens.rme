...
<html>
  <head>
 		<title>CTS Datenexport - U+4 Forecast</title>
  ...
  <body>
    <div id="wrap">
      ...
      <div class="col-md-2 col-sm-3 col-xs-4" id="menu">
        ...
        <div class="col-md-12"><span class="return-text">Datenexport<br /><span style="color:#FFFFFF"><i>U+4 Forecast</i></span></span></div>
      </div>
					...
					<div class="col-md-6">
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3 class="panel-title">Datenexport - Anleitung: <i>U+4 Forecast</i></h3>
							</div>
							<div class="panel-body">
								...
								<div><b><u>3. Schritt</u></b>: <i>Erstellen des "U+4 Forecasts"</i></div>
								<div class="offset-top-15">
