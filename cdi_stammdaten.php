  ...
  <body>
    <div id="wrap">
      ...
      <div class="col-md-2 col-sm-3 col-xs-4" id="menu">
        ...
        <div class="col-md-12"><span class="return-text">Datenimport<br /><span style="color:#FFFFFF"><i>Stammdaten</i></span></span></div>
      </div>
					...
					<div class="col-md-6">
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3 class="panel-title">Import: <b>Stammdaten</b></h3>
							</div>
							<div class="panel-body">
								<div>Schritt 1: Stammdatendatei auswählen</div>
