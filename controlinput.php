    ...
    <div id="wrap">
      ...
      <div class="col-md-2 col-sm-3 col-xs-4" id="menu">
			...
			<ul class="btn-group btn-group-lg btn-group-vertical">
				<li class="dropdown navbar-form">
					<a class="dropdown-toggle btn-lg btn-block" href="controlinput_pandl.php">
						P&amp;L
					</a>
				</li>
				<li class="dropdown navbar-form">
					<a class="dropdown-toggle btn-lg btn-block" href="controlinput_netcash.php">
						NetCash
					</a>
				</li>
				<li class="dropdown navbar-form">
					<a class="dropdown-toggle btn-lg btn-block" href="controlinput_stichtage.php">
						Stichtage
					</a>
				</li>
			</ul>
