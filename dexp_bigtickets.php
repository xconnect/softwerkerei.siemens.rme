...
<html>
  <head>
 		<title>CTS Datenexport - Big Tickets</title>
  ...
  <body>
    <div id="wrap">
      ...
      <div class="col-md-2 col-sm-3 col-xs-4" id="menu">
        ...
        <div class="col-md-12"><span class="return-text">Datenexport<br /><span style="color:#FFFFFF"><i>Big Tickets</i></span></span></div>
      </div>
					...
					<div class="col-md-6">
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3 class="panel-title">Datenexport - Anleitung: <i>Big Tickets</i></h3>
							</div>
							<div class="panel-body">
								...
								<div><b><u>3. Schritt</u></b>: <i>"Actuals" einbeziehen?</i></div>
								<div class="offset-top-15">
									<div class="checkbox">
										<label>
											<input type="checkbox"> verwende "Actuals"
										</label>
									</div>
								</div>
								...
								<div><b><u>4. Schritt</u></b>: <i>Erstellen des "Big Tickets"</i></div>
								<div class="offset-top-15">
